...
const { forgotOtpVerifier ,signupHandler,loginHandler,forgotOtpSenderHandler,registerOtpValidateHandler,changePasswordHandler,deleteForEditHandler,getUserData,logoutHandler} = require('../controllers/authentication.controller');
